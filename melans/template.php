        ...
        <div class="row probootstrap-vh-100 align-items-center text-center">
          <div class="col-sm">
            <div class="probootstrap-text">
              <h1 class="probootstrap-heading text-white mb-4">Меланс</h1>
              <div class="probootstrap-subheading mb-5">
                <p class="h4 font-weight-normal">Компания Меланс — это команда умных и добрых айтишников!</p>
              </div>
              <p><a href="/services.php" class="btn btn-primary mr-2 mb-2">Узнать о наших услугах</a></p>
            </div>
          </div>
        </div>
      </div>
